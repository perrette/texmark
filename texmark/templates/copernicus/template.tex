...
{% if running is defined and running.title -%}
...
{% if running.author is defined and running.author -%}
...
\copyrightstatement{ {{copyright}} }    %% This section is optional and can be used for copyright transfers.
{% endif %}
...
{% if codeavailability is defined -%}
\codeavailability{ {{codeavailability}} } %% use this section when having only software code available
{% endif -%}

{% if dataavailability is defined -%}
\dataavailability{ {{dataavailability}} } %% use this section when having only data sets available
{% endif -%}

{% if codedataavailability is defined -%}
\codedataavailability{ {{codedataavailability}} } %% use this section when having data sets and software code available
{% endif -%}

{% if sampleavailability is defined -%}
\sampleavailability{ {{sampleavailability}} } %% use this section when having geoscientific samples available
{% endif -%}

{% if videoavailability is defined -%}
\videoavailability{ {{videoavailability}} } %% use this section when having video supplements available
{% endif -%}
...
{% if authorcontribution is not defined -%}
...
{% if competinginterests is not defined -%}
